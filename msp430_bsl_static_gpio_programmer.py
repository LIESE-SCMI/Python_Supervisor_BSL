...
# ══════════════════════════════════════════════
#  BLOQUES HARDCODEADOS — GPIO.txt
#  3 segmentos TI-TXT → 3 comandos RX_DATA_BLOCK (MAX 256 bytes c/u)
#  Segmento @0x04400   32 bytes → bloque 00
#  Segmento @0x0FF80   16 bytes → bloque 01
#  Segmento @0x0FFCC  154 bytes → bloque 02
# ══════════════════════════════════════════════

FIRMWARE_BLOCKS = [
    # Bloque 00 — @0x04400 offset +0x0000  (32 bytes)
    (0x04400, bytes([
        0x81, 0x00, 0x00, 0x24, 0xB1, 0x13, 0x30, 0x00, 0xB1, 0x13, 0x62, 0x00, 0x0C, 0x43, 0xB1, 0x13,
        0x00, 0x00, 0x1C, 0x43, 0xB1, 0x13, 0x5C, 0x00, 0x32, 0xD0, 0x10, 0x00, 0xFD, 0x3F, 0x03, 0x43,
    ])),
    # Bloque 01 — @0x0FF80 offset +0x0000  (16 bytes)
    (0x0FF80, bytes([
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    ])),
    # Bloque 02 — @0x0FFCC offset +0x0000  (154 bytes)
    (0x0FFCC, bytes([
        ,
    ])),
]
...
def main():
    ...
    if args.file:
        ...
        print("[INFO] Sin archivo TI-TXT → usando firmware hardcodeado")
